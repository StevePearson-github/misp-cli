...
def add_attribute(
    ...
    comment: Optional[str] = typer.Option(None, "-m", "--comment", help="Comment"),
    json_output: bool = typer.Option(False, "--json", help="Output as JSON"),
):
...
def edit_attribute(
    ...
    value: Optional[str] = typer.Option(None, "-v", "--value", help="New value"),
    comment: Optional[str] = typer.Option(None, "-m", "--comment", help="New comment"),
    json_output: bool = typer.Option(False, "--json", help="Output as JSON"),
):
    """Edit an attribute."""
    from misp_cli.cli.app import get_app
